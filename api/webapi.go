...
var dbClient model.DBClient

func ListArticles(w http.ResponseWriter, r *http.Request) {
	articles, err := dbClient.ListArticles()
	if err != nil {
		fmt.Println(err)
...
func GetArticle(w http.ResponseWriter, r *http.Request) {
	article, err := dbClient.GetArticleByID(chi.URLParam(r, "articleID"))
	if err != nil {
		fmt.Println(err)
		render.Render(w, r, ErrDB())
		return
...
func DeleteArticle(w http.ResponseWriter, r *http.Request) {
	...
	err := dbClient.DeleteArticle(chi.URLParam(r, "articleID"))
	if err != nil {
		render.Render(w, r, ErrDB())
		return
	}
...
func NewUserPayloadResponse(user *model.User) *UserPayload {
...
func dbGetUser(id int64) (*model.User, error) {
	for _, u := range users {
		if u.ID == id {
			return u, nil
		}
